...
import { ArrowLeft, CheckCircle, Lock, Shield, Truck } from "lucide-react"
...
export default function CheckoutPage({ car, onBack }: CheckoutPageProps) {
      ...
      <div className="min-h-screen bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-slate-800 border border-purple-500/30 rounded-lg p-8 text-center space-y-6">
          ...
          <div className="bg-slate-700/50 border border-purple-500/20 rounded-lg p-4">
            ...
            <p className="text-lg font-bold text-purple-300">{car.name}</p>
            <p className="text-2xl font-bold text-white mt-2">${(total / 1000).toFixed(0)}K</p>
          </div>
